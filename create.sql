create table bookings (id integer not null auto_increment, dropoff_date datetime, pickup_date datetime, customer_id integer, product_id integer, primary key (id)) engine=MyISAM;
create table categories (id integer not null auto_increment, description varchar(255), name varchar(255), rating integer, url varchar(255), primary key (id)) engine=MyISAM;
create table cities (id integer not null auto_increment, country varchar(255), name varchar(255), primary key (id)) engine=MyISAM;
create table customers (id integer not null auto_increment, last_name varchar(255), name varchar(255), user_id integer, primary key (id)) engine=MyISAM;
create table features (id integer not null auto_increment, icon varchar(255), name varchar(255), primary key (id)) engine=MyISAM;
create table images (id integer not null auto_increment, title varchar(255), url varchar(255), product_id integer, primary key (id)) engine=MyISAM;
create table product_feature (product_id integer not null, feature_id integer not null, primary key (product_id, feature_id)) engine=MyISAM;
create table products (id integer not null auto_increment, description varchar(255), name varchar(255), category_id integer, city_id integer, primary key (id)) engine=MyISAM;
create table roles (id integer not null auto_increment, name varchar(255), primary key (id)) engine=MyISAM;
create table users (id integer not null auto_increment, email varchar(255), password varchar(255), role_id integer, primary key (id)) engine=MyISAM;
